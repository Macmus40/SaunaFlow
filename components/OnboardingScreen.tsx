...
const backgroundImage = 'https://images.pexels.com/photos/5582214/pexels-photo-5582214.jpeg';
      ...
      <main className="flex flex-col items-center justify-center flex-grow text-center p-4 sm:p-6">
        ...
        <div className="w-full max-w-sm mb-8">
          ...
          <input
              ...
              className="w-full bg-slate-800 border border-slate-700 rounded-lg p-4 text-lg focus:ring-amber-500 focus:border-amber-500"
              autoFocus
          />
        </div>
...
const GoalCard: React.FC<GoalCardProps> = ({ icon, title, description, onClick, disabled }) => (
    <button
        onClick={onClick}
        disabled={disabled}
        className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 text-left hover:bg-slate-700 hover:border-slate-500 transition-all duration-300 transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
    >
